...
(
    ...
    constraint cartstobepublished_collection_pkey primary key
(
    _id
)
...
create
or replace function public.cartstobepublished_notify_update_to_queue()
returns trigger
security definer
as $$
begin
