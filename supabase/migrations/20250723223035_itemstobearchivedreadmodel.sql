...
-- Create the itemstobearchived-collection table if not exists
create table if not exists public."itemstobearchived-collection"
(
    _id text                            not null,
    data       jsonb                    not null,
    ...
    constraint itemstobearchived_collection_pkey primary key (_id)
