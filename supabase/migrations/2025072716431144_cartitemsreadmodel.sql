...
-- Create the cart items-collection table if not exists
create table if not exists public."cart items-collection"
(
    _id text                            not null,
    data       jsonb                    not null,
    ...
    constraint cart items_collection_pkey primary key (_id)
