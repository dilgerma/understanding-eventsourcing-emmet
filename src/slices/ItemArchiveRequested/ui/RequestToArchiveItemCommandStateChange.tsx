...
import schema from './RequestToArchiveItemCommand.json'
import {parseEndpoint} from "../../../components/util/parseEndpoint";

export const RequestToArchiveItemCommandComponent = () => {
    const endpoint = "/api/requesttoarchiveitem"
    ...
    return <div>
        ...
        <h3>RequestToArchiveItemCommand</h3>
        <div>
