...
import {InventoriesReadModel} from "@/app/slices/Inventories/InventoriesProjection";
...
export async function GET(req: NextRequest) {
    try {
        ...
        const db = client.db();
        const collection = db.collection<InventoriesReadModel>("Inventories-collection")
