...
import {SubmittedCartDataReadModel} from "@/app/slices/SubmittedCartData/SubmittedCartDataProjection";
...
export async function GET(req: NextRequest) {
    try {
        ...
        const db = client.db();
        const collection = db.collection<SubmittedCartDataReadModel>("SubmittedCartData-collection")
